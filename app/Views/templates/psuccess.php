      ...
      <div class="col-md-10 mx-auto mt-5">
         ...
         <div class="payment">
            ...
            <div class="content">
               ...
               <p>You have successfully purchased <b><?=$pdata['product_name']?></b>.</p>
...
window.dataLayer.push({
    'transactionId': "<?=$pdata['order_id']?>",
    'transactionTotal': "<?=$pdata['payment_amount']?>",
    'transactionProducts': [{
        'sku': "<?=$pdata['product_id']?>",
        'name': "<?=$pdata['product_name']?>",
        'price': "<?=$pdata['payment_amount']?>",
        'quantity': 1
    }]
  });
 window.dataLayer.push({
     ...
     'actual_product_value': "<?=$pdata['offer_price']?>",
     'final_product_value': "<?=$pdata['payment_amount']?>",
     'admitad_uid': 'step',
     'email': "<?=$pdata['email']?>",
     'phone': "<?=$pdata['phone']?>",
 });
