...
<div class="product-plans-page">
    <div class="ppp-top-section">
        <div class="ppp-top-section-bg">
            <div class="course-type-box-highlight course-type-box-workProf"></div>
        </div>
        <h1 class="ppp-title">English for <span class="greenHigh">Competitive Exam Preparation</span></h1>
        <p class="ppp-description">Courses focusing on English language skills for success in national level competitive exams: UPSC (Prelims and Mains), IBPS/Bank (PO and Clerical), SSC (CGL and CHSL), and other government exams (Insurance, CDS, etc.)</p>
    </div>
    ...
    <div class="title-tab-contents">
        <div class="title-tab-main title-tab-main-label pad-rgt">
            ...
            <div class="title-tab-row">
                Live calls <span class="popover-element" data-toggle="popover" data-content="">+</span>
            </div>
            <div class="title-tab-row">
        ...
        <div class="title-tab-main-texts"> <?php 

        $productLinks = [617 => 'exam-preparation-crash-course',  608 => 'exam-preparation-unlimited']; 

        $productDetails = [617 =>['product_name' => 'STEP for Competitive Exams - Crash Course','live_calls' => 'None','online_classes' => '10 hours','Validity'=>'3 months','course_covers'=>'- interview skills <br /> - exam tips and tricks <br /> - speaking skills <br /> - listening skills <br /> - reading skills <br /> - writing skills <br /> - grammar <br /> - vocabulary','sub_para' => 'Can only manage flexible online lessons'],608 => ['product_name' => 'STEP for Exam Prep – Unlimited','live_calls' => 'Unlimited','online_classes' => '60 hours','Validity'=>'3/6/12 months','course_covers'=>'- interview skills <br /> - exam tips and tricks <br /> - speaking skills <br /> - listening skills <br /> - reading skills <br /> - writing skills <br /> - grammar <br /> - vocabulary','sub_para' => 'Want flexible online lessons PLUS unlimited personalised one-on-one coaching and interactive live session with experienced trainer'],613 => ['original_price' => 10999,'offer_price' => 9499,'original_price_usd' => 132,'offer_price_usd' => 114],
            ...
            foreach ($CourseDetails as $index => $course) { 
                if ($course['product_id'] == 617 || $course['product_id'] == 608):
                        ...
                        <div class="title-tab-main-flex-1">
                            ...
                            <div class="title-tab-row title-tab-row-months">
                                <a href="javascript:void(0)" class="border-btn active"
                                    ...
                                    data-OfferPrice="<?= $course['offer_price'] ?>"><?= $details['Validity'] ?></a>
                            </div>
                            <div class="title-tab-row">
    ...
    <div class="ppp-top-section ppp-footer-section">
        ...
        <?php 
        $productNames = [ 'General Communication','Working Professionals', 'IELTS']; 
        $nameIndex = 0;
        foreach ($productData as $index => $product): ?>
            <?php if ($product['product_name_slug'] != 'stepforcompexams' ): ?>
