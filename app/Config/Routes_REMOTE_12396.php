...
$routes->get('/stepcoachunl', 'Home::generalcommunication');
$routes->get('/stepforcompexams', 'Home::examprep');
$routes->get('/stepforielts', 'Home::ieltsprep');
$routes->get('/stepforworkingprofessionals', 'Home::workingProfessional');
...
$routes->get('/forcorporate', 'Home::forcorporate');
$routes->get('/forinstitution', 'Home::forinstitution');
